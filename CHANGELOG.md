...
### Fixed
- Added missing runtime dependency `mcp>=1.26.0` required by `src/stdio_bridge.py`.
- Fixes clean-environment installs where `ModuleNotFoundError: No module named 'mcp'` occurred when using Copilot stdio bridge.
